import{n as e}from"./assets/rolldown-runtime.js";import{a as t,i as n,n as r,o as i,r as a,s as o,t as s}from"./assets/card-base.js";import{i as c,n as l,o as u,t as d}from"./assets/lit.js";var f,p,m=e((()=>{n(),i(),d(),r(),f=class extends l{static get properties(){return{_config:{type:Object}}}setConfig(e){this._config=e||{}}render(){if(!this._config)return c`<div>Please configure the card.</div>`;let e=this._getSchema(),t=e.slice(0,3),n=e.slice(3,5),r=e.slice(5);return c`
            <style>
